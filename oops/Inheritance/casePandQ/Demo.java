...
public class Demo {
    public static void main(String[] args) {
        ...
        System.out.println(parent.a);//100
        ...
        System.out.println(child.a);//a is only present inside the parent class ---> Parent  //100
        System.out.println(child.b);//b is only present child class ---? Child               //200
        System.out.println(child.c);//c is present in both parent and child class ---> Child //3000
        ...
        System.out.println(parentReference.a);//100
